...
<table>
   <tr>
    <td align="right" colspan="2" bgcolor="<%=value_c%>">
	    <a href="./template.jsp?page=freelist.freelist.jsp"> 글목록</a> 
   </td>
   </tr>
   <tr>
  ...
  <tr>
    ...
    <td  width="330" align="left">
     <textarea name="context" rows="13" cols="40" 
  ...
  <tr>      
    <td colspan=2 bgcolor="<%=value_c%>" align="center"> 
      ...
      <input type="button" value="목록보기" OnClick="window.location='./template.jsp?page=freelist.jsp'">
    </td>
  </tr>
</table>    
 <%
